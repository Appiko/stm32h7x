...
//  HAL_GPIO_WritePin(DCMI_PWRDN_GPIO_Port, DCMI_PWRDN_Pin, GPIO_PIN_RESET);
  ...
  /*Configure GPIO pin : PtPin */
  GPIO_InitStruct.Pin = CAM_TRIGGER_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_IT_FALLING;
  GPIO_InitStruct.Pull = GPIO_PULLUP;
  HAL_GPIO_Init(CAM_TRIGGER_GPIO_Port, &GPIO_InitStruct);
  ...
  /*Configure GPIO pin : PtPin */
//  GPIO_InitStruct.Pin = DCMI_PWRDN_Pin;
//  GPIO_InitStruct.Mode = GPIO_MODE_OUTPUT_PP;
//  GPIO_InitStruct.Pull = GPIO_NOPULL;
//  GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
//  HAL_GPIO_Init(DCMI_PWRDN_GPIO_Port, &GPIO_InitStruct);
//
  /* EXTI interrupt init*/
